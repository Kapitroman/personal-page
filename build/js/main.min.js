...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_change_language__WEBPACK_IMPORTED_MODULE_5__["initChangeLanguage"])(); // Modules
  // ---------------------------------
...
var DynamicAdaptive = /*#__PURE__*/function () {
  ...
  _createClass(DynamicAdaptive, [{
    ...
    value: function init() {
      ...
      // массив объектов
      this._objectsArray = [];
      this._daClassName = 'dynamic-adaptive'; // массив DOM-элементов

      this._nodes = document.querySelectorAll('[data-da]'); // наполнение objects объектами
      ...
      this._arraySort(); // массив уникальных медиа-запросов
...
var changeLanguage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(langValue) {
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      languageData = _context2.sent;

                      _loop = function _loop(key) {
                        var elems = Array.from(document.querySelectorAll("[data-lang-key=\"".concat(key, "\"]")));
...
var initChangeLanguage = function initChangeLanguage() {
  ...
  if (savedLangValue !== null) {
    currentRadio = document.querySelector(".toggle-language__input[value=".concat(savedLangValue, "]"));
    lang = savedLangValue;
  } else {
  ...
  changeLanguage(lang);
  var toggleLanguage = document.querySelector('.toggle-language');
